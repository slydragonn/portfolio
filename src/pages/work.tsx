  ...
  return (
      <main>
        ...
        <section className='mt-20'>
          <ProjectItem 
            image={{url: '/assets/work/youtube-min.png', alt: 'slydragonn youtube channel'}}
            title='Latest Youtube Video'
            summary='My videos are about how I program different types of projects.'
            link='https://www.youtube.com/@slydragonn'
          />
          <ProjectItem 
            image={{url: '/assets/work/blue-river.png', alt: 'Blue River home page design'}}
          ...
          />
          <ProjectItem 
            image={{url: '/assets/work/portfolio.png', alt: 'Alejandro Londoño Portfolio'}}
            title='Developer Portfolio'
            summary='This Website is made with Nextjs and TypeScript.'
            link='/'
          />
          <ProjectItem 
            image={{url: '/assets/work/barber.png', alt: 'Barber website design'}}

...
const ArticleCard = ({creationDate, title, content, categories, url}: ArticleCardProps) => {
  ...
  return (
    <article>
      ...
      <LinkItem href={url} isExternal><h3 className='text-xl font-semibold mt-4 text-black dark:text-white'>{title}</h3></LinkItem>
      <p className='text-sm font-light text-black dark:text-white mt-2'>{content}</p>
      <div>
      {
